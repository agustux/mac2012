...
mkdir ansible
curl -LO https://github.com/agustux/mac2012/archive/refs/tags/v0.0.3.tar.gz
tar -xvf $HOME/v0.0.3.tar.gz -C ~
ANSIBLE_CONFIG=mac2012-0.0.3/ansible.cfg ./ansible_venv/bin/ansible-playbook mac2012-0.0.3/installation.yml
ANSIBLE_CONFIG=mac2012-0.0.3/ansible.cfg ./ansible_venv/bin/ansible-playbook mac2012-0.0.3/configuration.yml
