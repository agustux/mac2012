...
mkdir ansible
curl -LO https://github.com/agustux/mac2012/archive/refs/tags/v1.0.8.tar.gz
tar -xvf $HOME/v1.0.8.tar.gz -C ~
ANSIBLE_CONFIG=mac2012-1.0.8/ansible.cfg ./ansible_venv/bin/ansible-playbook mac2012-1.0.8/installation.yml
ANSIBLE_CONFIG=mac2012-1.0.8/ansible.cfg ./ansible_venv/bin/ansible-playbook mac2012-1.0.8/configuration.yml
