...
mkdir ansible
curl -LO https://github.com/agustux/mac2012/archive/refs/tags/v1.0.7.tar.gz
tar -xvf $HOME/v1.0.7.tar.gz -C ~
ANSIBLE_CONFIG=mac2012-1.0.7/ansible.cfg ./ansible_venv/bin/ansible-playbook mac2012-1.0.7/installation.yml
ANSIBLE_CONFIG=mac2012-1.0.7/ansible.cfg ./ansible_venv/bin/ansible-playbook mac2012-1.0.7/configuration.yml
