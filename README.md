...
mkdir ansible
curl -LO https://github.com/agustux/mac2012/archive/refs/tags/v0.1.5.tar.gz
tar -xvf $HOME/v0.1.5.tar.gz -C ~
ANSIBLE_CONFIG=mac2012-0.1.5/ansible.cfg ./ansible_venv/bin/ansible-playbook mac2012-0.1.5/installation.yml
ANSIBLE_CONFIG=mac2012-0.1.5/ansible.cfg ./ansible_venv/bin/ansible-playbook mac2012-0.1.5/configuration.yml
