...
mkdir ansible
curl -LO https://github.com/agustux/mac2012/archive/refs/tags/v0.1.2.tar.gz
tar -xvf $HOME/v0.1.2.tar.gz -C ~
ANSIBLE_CONFIG=mac2012-0.1.2/ansible.cfg ./ansible_venv/bin/ansible-playbook mac2012-0.1.2/installation.yml
ANSIBLE_CONFIG=mac2012-0.1.2/ansible.cfg ./ansible_venv/bin/ansible-playbook mac2012-0.1.2/configuration.yml
